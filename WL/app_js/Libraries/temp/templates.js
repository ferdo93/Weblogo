/*
function create_dropup(){
	var div = '';
	div += '<div class="dropdown-menu ">';	
		div += '<ul class="pagination" style="display: relative !important;">';
			div += '<li><a class="select_value" style="cursor:pointer;">1</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">2</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">3</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">4</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">5</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">6</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">7</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">8</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">9</a></li>';
			div += '<li><a class="select_value" style="cursor:pointer;">Index</a></li>';
		div += '</ul>';
	div += '</div>';
	return div;
}
...
function command_div_text(name, value){
	...
	div += '<span class="input-group-addon"><span class="glyphicon glyphicon-text-size"></span></span>';
	div += '<input type="text" class="form-control comm_value" placeholder="text" value="'+value.replace(/_/g,' ')+'" onKeyPress="javascript:set_text(this);">';
	div += '</div>';
	div += '</div>';
	div += '</div></div>';
	return div;
...
/*
function command_div_proc(name, name_save, end_name, value){
	var div2 = document.createElement('div');
	var div = '<div class="ui-draggable" style="display: block;">';
	div += '<div class="row body list-group-item panel panel-info panel-collapse command proc '+name+'" style="margin: 0px; padding: 0px;  margin-bottom: 2%;">';
	div += '<div class="panel-heading">';
	div += '<div class="row text-center">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered proc-name" style="cursor: pointer"><span class="lang-procedure">'+name+'</span></p> ';
	...
	div += '<button class="btn btn-box-tool collapseOne pull-left" aria-expanded="true" type="button"><i class="fa fa-minus"></i></button>';
	div += '<button class="btn btn-success fa fa-plus-square col-sm-2 " style="" type="button"></button>';
	div += '</div>';
	div += '<div class="row"><div class="parameter-variables"></div></div>';
	div += '<button class="btn btn-block btn-info save-proc" type="button" style="margin-top:3%">';
	div += '<i class="fa fa-floppy-o" aria-hidden="true">  </i>';
	div += '<span class="lang-proc-save">'+name_save+'</span>';
	div += '</button>';
	div += '</div>';
	div += '<div class="panel-collapse collapse-com in" aria-expanded="true">';
	div += '<div class="panel-body command-loop" style="padding: 10px 0px;"><ul class="list-unstyled ui-sortable">';
	div += '<li></li></ul>';
	div += '</div>';
	div += '<div class="panel-footer text-center command com-end-proc">';
	div += '<p class="col-centered"><span class="lang-end-procedure">'+end_name+'</span></p>';
	div += '</div>';
	div += '</div>';
	div += '</div>';
	div += '</div>';
...
function command_proc_call_thumb(name, name_save, end_name, value){
	var div2 = document.createElement('div');
	var div = '<div class="ui-draggable" style="display: block;">';
	div += '<div class="row body list-group-item panel panel-info panel-collapse command proc '+name+'" style="margin: 0px; padding: 0px;  margin-bottom: 2%;">';
	div += '<div class="panel-heading">';
...
/*
function command_div_proc_first_part(name, name_save, value){
	//var div2 = document.createElement('div');
	var div = '<div class="ui-draggable" style="display: block;">';
	div += '<div class="row body list-group-item panel panel-info panel-collapse command proc '+name+'" style="margin: 0px; padding: 0px;  margin-bottom: 2%;">';
	div += '<div class="panel-heading">';
...
function command_div_proc_second_part(end_name){
	var div2 = document.createElement('div');
	var div = '</li></ul>';
	div += '</div>';
	div += '<div class="panel-footer text-center command com-end-proc">';
...
function command_div_loop_first_part(name, value){
	...
	div += '<div class="panel-heading">';
	div += '<div>';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-loop">'+name+'</span></p> ';
	div += '<i class="fa fa-times col-centered pull-right" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 pull-right" type="button"></button>';
...
function command_div_forward_st(name, value){
	var div = '<div class="row body list-group-item command fd" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-forward">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value">'+value+'</b><b class="caret"></b></a>';
	div += '<ul class="dropdown-menu" style="left:auto; right:0; margin:0; padding:0; line-height:0.8;">';
...
function command_div_left_st(name, value){
	var div = '<div class="row body list-group-item command lt" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-left">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value lt">'+value+'</b><b class="caret"></b></a>';
	div += '<ul class="dropdown-menu" style="left:auto; right:0; margin:0; padding:0; line-height:0.8;">';
	div += '<ul class="pagination pagination-responsive pagination-sm" style="margin:0;">';
	div += '<li><a class="select_value" style="cursor:pointer;">0</a></li><li><a class="select_value" style="cursor:pointer;">45</a></li><li><a class="select_value" style="cursor:pointer;">90</a></li><li><a class="select_value" style="cursor:pointer;">135</a></li><li><a class="select_value" style="cursor:pointer;">180</a></li><li><a class="select_value" style="cursor:pointer;">225</a></li><li><a class="select_value" style="cursor:pointer;">270</a></li><li><a class="select_value" style="cursor:pointer;">315</a></li><li><a class="select_value" style="cursor:pointer;">360</a></li>';
	div += '</ul>';								  
	div += '</ul>';
	div += '</div>';
	div += ' <button class="btn btn-warning fa fa-minus-circle col-sm-2 col-centered pull-right" type="button"></button>';
...
function command_div_right_st(name, value){
	var div = '<div class="row body list-group-item command rt" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-right">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value rt">'+value+'</b><b class="caret"></b></a>';
...
function command_div_pw_st(name, value){
	var div = '<div class="row body list-group-item command pw" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-pen-weight">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value">'+value+'</b><b class="caret"></b></a>';
...
function command_div_point(name, value){
	var div = '<div class="row body list-group-item command point" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-point">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value">'+value+'</b><b class="caret"></b></a>';
...
function command_div_time_st(name, value){
	var div = '<div class="row body list-group-item command time" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-time">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<button class="btn btn-success fa fa-plus-circle col-sm-2 col-centered pull-right" type="button"></button>';
	div += '<div class="dropup">';
	div += '<a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default fa col-sm-2 text pull-right num_value"><b class="com_value">'+value+'</b><b class="caret"></b></a>';
...
function command_div_pc_st(name, value){
	var div = '<div class="row body list-group-item command pc" style="margin: 0px;  margin-bottom: 2%;">';
	div += '<p class="col-lg-3 col-md-3 col-sm-2 col-xs-2 col-centered"><span class="lang-pen_color">'+name+'</span></p>';
	div += '<i class="fa fa-times col-centered pull-right" aria-hidden="true" style="color:red; padding:5px; padding-left:5%; padding-top:0px;cursor:pointer;"></i>';
	div += '<div class="pull-right">';
		div += '<select name="colorpicker-picker-longlist" class="com_value">';
			div += '<option value="#000000">#000000</option>';
			div += '<option value="#ac725e">#ac725e</option>';
			div += '<option value="#d06b64">#d06b64</option>';
			div += '<option value="#f83a22">#f83a22</option>';
		...
		div += '</select>';
	div += '</div>';
	div += '<div class="btn btn-xs pull-right"><label><input type="checkbox" value="" class="color-random" id="checkbox">Náhodne</label></div>';
	div += '</div>';
	return div;
}
*/
